    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_images', models.ImageField(blank=True, upload_to=myblog.models.save_images, verbose_name='Изображение пункта')),
                ('post', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='myblog.post')),
            ],
        ),
    ]
